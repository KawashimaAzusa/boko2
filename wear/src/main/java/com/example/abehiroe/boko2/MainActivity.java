package com.example.abehiroe.boko2;
...
//                }
    ...
    private int detectMotion(float x, float y, float z,float x2, float y2, float z2) {
        ...
        //きゅんきゅん
        if(Math.abs(diffX)> 20 && Math.abs(diffX) <= 30){
            if (delay == 0) {
                Log.d(TAG, "don1!");
                motion = 4;
            }
        }else if(Math.abs(diffX)>30 && Math.abs(diffX) <= 40){
            if (delay == 0) {
                Log.d(TAG, "don2!");
                motion = 5;
            }
        }else if(Math.abs(diffX)>40 && Math.abs(diffX) <= 50){
            if (delay == 0) {
                Log.d(TAG, "don3!");
                motion = 6;
            }
